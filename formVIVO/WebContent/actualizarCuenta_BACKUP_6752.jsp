    ...
    <section id="login" class="hidden">
        ...
        <form role="form" id="login-form" action="/vivo/authenticate" method="post" name="login-form" />
            ...
            <div  >
                ...
                <label for="loginName">Correo electrónico</label>
                ...
                <p class="submit">
                    <input name="loginForm" class="green button" type="submit" value="Iniciar sesión"/><br/>
                </p>
...
>>>>>>> 317a35ecbda884c86de6a3dacc2b96d9a708e70e
</body>
</html>